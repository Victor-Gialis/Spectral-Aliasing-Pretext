...
from models.backbone.cnn import CNNEncoder
...
def main(args):
    ...
    # Backbone
    backbone_random = CNNEncoder()
    ssl_mode = TSTCCModel(backbone=backbone_random
    ...
    args.timesteps = ssl_model.timesteps
