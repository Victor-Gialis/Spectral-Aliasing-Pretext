...
def main(args):
    ...
    args_backbone = SimpleNamespace(
        ...
        normalization=None, # Use z-score normalization
    ...
    # --------------------------------------------------------
    model = TSTCCModel(backbone, args_ssl).to(device)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Pretrain TS-TCC Model")
    ...
    parser.add_argument('--timesteps', type=int, default=4, help='Number of future timesteps to predict in temporal contrasting')
